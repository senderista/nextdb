...
static constexpr size_t c_pause_cycles_x86_default{10};
// On Skylake, PAUSE has latency of ~140 cycles (!).
static constexpr size_t c_pause_cycles_skylake{140};
// On Cascade Lake and later Intel uarchs, PAUSE has latency of ~40 cycles.
static constexpr size_t c_pause_cycles_cascadelake{40};
...
static constexpr size_t c_cycles_per_ns{3};
static constexpr size_t c_ns_per_us{1000};
...
static constexpr size_t c_pause_cycles{c_pause_cycles_cascadelake};
inline constexpr size_t c_pause_iterations_per_us{(c_cycles_per_ns * c_ns_per_us) / c_pause_cycles};

inline void spin_wait(size_t iterations)
{
