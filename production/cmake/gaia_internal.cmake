...
function(add_gtest TARGET SOURCES INCLUDES LIBRARIES)
   ...
   message(VERBOSE "SOURCES = ${SOURCES}")
   message(VERBOSE "INCLUDES = ${INCLUDES}")
   message(VERBOSE "LIBRARIES = ${LIBRARIES}")
   message(VERBOSE "ARGV0 = ${ARGV0}")
   message(VERBOSE "ARGV1 = ${ARGV1}")
   message(VERBOSE "ARGV2 = ${ARGV2}")
